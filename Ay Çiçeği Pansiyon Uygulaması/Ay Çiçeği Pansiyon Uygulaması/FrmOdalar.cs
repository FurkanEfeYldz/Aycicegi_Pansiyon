...
namespace Ay_Çiçeği_Pansiyon_Uygulaması
{
    public partial class FrmOdalar : Form
    {
        ...
        private void BtnOda101_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(BtnOda101.Text);
            }
            else
            {
                MessageBox.Show("Bu Oda Boştur");
            }
        }
        ...
        private void BtnOda102_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(BtnOda102.Text);
            }
            else
            {
                MessageBox.Show("Bu Oda Boştur");
        ...
        private void BtnOda103_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(BtnOda103.Text);
            }
            else
            {
                MessageBox.Show("Bu Oda Boştur");
        ...
        private void BtnOda104_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(BtnOda104.Text);
            }
            else
            {
                MessageBox.Show("Bu Oda Boştur");
        ...
        private void BtnOda105_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(BtnOda105.Text);    
            }
            else
            {
                MessageBox.Show("Bu Oda Boştur");
        ...
        private void BtnOda106_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(BtnOda106.Text);
            }
            else
            {
                MessageBox.Show("Bu Oda Boştur");
        ...
        private void BtnOda107_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(BtnOda107.Text);
            }
            else
            {
                MessageBox.Show("Bu Oda Boştur");
        ...
        private void BtnOda108_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(BtnOda108.Text);
            }
            else
            {
                MessageBox.Show("Bu Oda Boştur");
        ...
        private void BtnOda109_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(BtnOda109.Text);
            }
            else
            {
                MessageBox.Show("Bu Oda Boştur");
