...
namespace Ay_Çiçeği_Pansiyon_Uygulaması
{
    public partial class FrmYeniMusteri : Form
    {
        ...
        {
            if (DtpGirisTarihi.Value < DtpCikisTarihi.Value && TxtKimlikNo.TextLength > 10)  
            {
                baglanti.Open();
                ...
                {
                    baglanti.Open();
                    SqlCommand komut2 = new SqlCommand("insert into Oda109 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyAdi.Text +  "')", baglanti);
                ...
                {
                    baglanti.Open();
                    SqlCommand komut3 = new SqlCommand("insert into Oda108 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyAdi.Text +  "',)", baglanti);
                ...
                {
                    baglanti.Open();
                    SqlCommand komut4 = new SqlCommand("insert into Oda107 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyAdi.Text +  "')", baglanti);
                ...
                {
                    baglanti.Open();
                    SqlCommand komut5 = new SqlCommand("insert into Oda106 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyAdi.Text +  "')", baglanti);
                ...
                {
                    baglanti.Open();
                    SqlCommand komut6 = new SqlCommand("insert into Oda105 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyAdi.Text +  "')", baglanti);
                ...
                {
                    baglanti.Open();
                    SqlCommand komut7 = new SqlCommand("insert into Oda104 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyAdi.Text +  "')", baglanti);
                ...
                {
                    baglanti.Open();
                    SqlCommand komut8 = new SqlCommand("insert into Oda103 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyAdi.Text +  "')", baglanti);
                ...
                {
                    baglanti.Open();
                    SqlCommand komut9 = new SqlCommand("insert into Oda102 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyAdi.Text +  "')", baglanti);
                ...
                {
                    baglanti.Open();
                    SqlCommand komut10 = new SqlCommand("insert into Oda101 (Adi,Soyadi) values ('" + TxtAdi.Text + "','" + TxtSoyAdi.Text +  "')", baglanti);
...
//Data Source=DESKTOP-2FGBHR3\SQLEXPRESS;Initial Catalog=AycicegiPansiyon;Integrated Security=True